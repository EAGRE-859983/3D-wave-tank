...
def test_case():
    ...
    save_path = 'data/'+scheme+'/'+dim+'/TC2_h01_t2_FWF/'
...
def domain(bottom):
    ...
    if bottom=='nonuniform':
        ...
        Lx = 100
    Ly = 0.8                                                  # Length in y
    Lw = 0.8                                        # End of the x-transform
    res_x = 0.1                                             # x-resolution
    res_y = 0.1                                             # y-resolution
...
def wavemaker(dim, H0, Ly, Lw, input_data):
    ...
    t_stop = 7.0                                     # When to stop the wavemaker
